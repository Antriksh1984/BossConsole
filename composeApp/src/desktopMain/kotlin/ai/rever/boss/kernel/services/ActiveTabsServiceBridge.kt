 ...
 *
 * These guards protect this service only. ProjectData still exposes unguarded operations on the
 * same server (a separate fix in flight); BossConsole#53 tracks the remaining IPC surface.
 */
